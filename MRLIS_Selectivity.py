...
def main():
    ...
    selection_intensity = 5658.84 # Intensity of laser W/m^2 (1W with 1.5cm spot size)
    ...
    first_pass_abundances = calculate_excited_abundances(goalIsotope, isotopes461, linewidth_461, 0.1*selection_intensity, Isat_461)
    ...
    second_pass_abundances = calculate_excited_abundances(goalIsotope, isotopes_after_first_pass, linewidth_461, 0.1*selection_intensity, Isat_461)
